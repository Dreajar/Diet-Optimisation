...
```math
A[calories]x \approx 1023.61
A[fat] = 45.3957
A[carbs] = 110.49
A[protein] = 51.9768
```
For the interested reader, here are the first few vectors generated by the sequence of $(r_k)$:
...
5. Instead of using the barrier $1/g_i(x)$, I could replace it with a merit function that increases the barrier function to \infty whenever any of the constraints are violated. However, this would again require the use of subdiferentials and hyperplanes.
